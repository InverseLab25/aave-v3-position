...
import { aaveV3StrategiesAbi, getStrategiesPauseState, planOpen, ZERO_STRATEGIES_SIG, type OpenMode } from "./strategies";
...
const base = {
  ...
  minOut: 4n, router: R, swapData: "0x" as const, delegation: ZERO_STRATEGIES_SIG,
};
