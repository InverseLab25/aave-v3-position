...
export const CHAIN_CONFIGS: Record<number, ChainConfig> = {
  1: {
    ...
    adapters: ['KyberSwap', 'Socket', 'OpenOcean', 'ParaSwap', 'CowSwap', 'Odos', '0x'],
    defaultTokens: [
  ...
  10: {
    ...
    adapters: ['KyberSwap', 'Socket', 'OpenOcean', 'ParaSwap', 'Odos', '0x'],
    defaultTokens: [
  ...
  8453: {
    ...
    adapters: ['KyberSwap', 'Nordstern', 'Socket', 'OpenOcean', 'ParaSwap', 'Odos', '0x'],
    defaultTokens: [
      { underlyingAsset: '0x4200000000000000000000000000000000000006', symbol: 'WETH', decimals: 18 },
  ...
  42161: {
    ...
    adapters: ['KyberSwap', 'Nordstern', 'Socket', 'OpenOcean', 'ParaSwap', 'CowSwap', 'Odos', '0x'],
    defaultTokens: [
